...
class TransactionController extends Controller
{
    ...
    public function getQrisInfo()
    {
        return response()->json([
            'status'    => 'success',
            'merchant'  => 'DEPOT AIR MINUM SMART WAT',[cite: 1]
            'nmid'      => 'ID1026567767466',[cite: 1]
            'qr_string' => '00020101021126670016ID.CO.INTERACTIVE.WWW01189360081510265677674660215ID10265677674660303UMI51440014ID.CO.QRIS.WWW0215ID10265677674660303UMI5204599953033605802ID5928DEPOT AIR MINUM SMART WAT6013SEMARANG61055011162070703A0163045E7A',[cite: 1]
            'price'     => 1000
        ], 200);
    }
}